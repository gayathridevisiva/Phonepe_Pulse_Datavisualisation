...
icon = Image.open(r"C:\Users\HP\OneDrive\Desktop\data\title.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Gayathri Devi",
                   page_icon= icon,
                   layout= "centered",
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r'C:\Users\HP\OneDrive\Desktop\data\Statenames.csv')
            df1.State = df2
